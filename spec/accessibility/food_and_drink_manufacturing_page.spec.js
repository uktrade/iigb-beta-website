...
describe('Accessibility testing', function() {
  ...
  beforeEach(function(done) {
    driver.get(baseUrl + '/int/industries/food-and-drink-manufacturing').then(function () {
  ...
  it('the food and drink manufacturing page should be accessible', function (done) {
    AxeBuilder(driver)
      .analyze(function(results) {
        buildOutput("Food and drink manufacturing page", results);
