...
describe('Accessibility testing', function() {
  ...
  beforeEach(function(done) {
    driver.get(baseUrl + '/int/industries/energy/offshore-wind').then(function () {
  ...
  it('the offshore wind page should be accessible', function (done) {
    AxeBuilder(driver)
      .analyze(function(results) {
        buildOutput("Offshore wind page", results);
