...
describe('Accessibility testing', function() {
  ...
  beforeEach(function(done) {
    driver.get(baseUrl + '/int/setup-guide/access-talent').then(function () {
  ...
  it('the access talent page should be accessible', function (done) {
    AxeBuilder(driver)
      .analyze(function(results) {
        buildOutput("Access talent page", results);
