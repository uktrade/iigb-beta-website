...
describe('Accessibility testing', function() {
  ...
  beforeEach(function(done) {
    driver.get(baseUrl + '/int/setup-guide/establish-address').then(function () {
  ...
  it('the establish address page should be accessible', function (done) {
    AxeBuilder(driver)
      .analyze(function(results) {
        buildOutput("Establish address page", results);
