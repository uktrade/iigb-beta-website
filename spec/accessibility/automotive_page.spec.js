...
describe('Accessibility testing', function() {
  ...
  beforeEach(function(done) {
    driver.get(baseUrl + '/int/industries/automotive').then(function () {
  ...
  it('the automotive page should be accessible', function (done) {
    AxeBuilder(driver)
      .analyze(function(results) {
        buildOutput("Automotive page", results);
